...
const IDler = {
  botID: "847060617915531295",
  botSecret: "txUELHR6eN0xpjhU2iAWK78UbLEMwakZ",
  botCallbackURL: "http://equesferrumcodes.cf/callback",
  sunucuID: "846646560125485066",
  sunucuDavet: "https://discord.gg/VxdUBfsmnE",
  kodLogKanalı: "846662260700872724",
  sahipRolü: "846660244100218910",
  adminRolü: "847066686482153472",
  kodPaylaşımcıRolü: "847066801421942804",
  boosterRolü: "",
  kodPaylaşamayacakRoller: ["846660264735801404", "846660269878280192"],
  hazırSistemlerRolü: "847066992812883988",
  sistemlerrolü: "847066992812883988",
  elmasKodlarRolü: "847067103394791445",
  altınKodlarRolü: "847067096231313408",
  normalKodlarRolü: "847067099791622235"
};
    ...
    return res.redirect(
      url.format({
        ...
        query: {
          statuscode: 138,
          message:
            "Kod paylaşabilmek için Discord sunucumuza katılmanız ve siteye giriş yapmanız gerekmektedir. Sunucunun Sohbet Kanalında Aktif olmanız Zorunludur."
        }
      })
    );
...
app.post("/paylasim", (req, res) => {
  ...
  client.channels.cache.get(IDler.kodLogKanalı).send(
    ...
    .addField("Kod id",`**${obj.id}**`)
    .addField("Kod Sayfası", `[Tıkla!](http://equesferrum.ml/${obj.kod_rank}/${obj.id})`));
...
client.on("ready", () => {
  const listener = app.listen(process.env.PORT, function() {
    client.user.setActivity(`EquesFerrum Code`, { type:"WATCHING" })
